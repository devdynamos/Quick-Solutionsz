  ...
  return (
    ...
    <div className="assignment-container">
      <div className="left-content">
        <h1>Custom made Master thesis writing help</h1>
        <p>Requirements that are fully furnished</p>
        <p>
        We archive your success through fulling your request and not letting go of our beloved clients retaining satisfaction with:
        </p>
        <ul>
          <li>✔ 100% Assurance</li>
          <li>✔ Money back guarantee</li>
          <li>✔ Subject experts writers</li>
